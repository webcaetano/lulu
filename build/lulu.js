...
module.exports = function (game) {
	...
	var createCarret = function createCarret() {
		var size = arguments.length <= 0 || arguments[0] === undefined ? 3 : arguments[0];

		var carret = game.add.graphics(0, 0).beginFill('0x5E1212', 0.8)
		// .drawCircle(0,0,size);
		.drawPolygon([{ x: size / 2, y: 0 }, { x: size, y: size }, { x: 0, y: size }, { x: size / 2, y: 0 }]);
	...
	var setBody = function setBody(pointer, options) {
		var size = 15;
		var bkg = game.add.graphics(0, 0);

		bkg.beginFill('0xFF0000', 0.5).lineStyle(1, '0xFF0000', 0.7).drawCircle(0, 0, size);
	...
	var setBodyMini = function setBodyMini(pointer, options) {
		var size = 7;
		var bkg = game.add.graphics(0, 0);

		bkg.beginFill('0xFF0000', 0.3).lineStyle(0.5, '0xFF0000', 0.8).drawCircle(0, 0, size);

		pointer.addChild(bkg);
	};

	var setDrag = function setDrag(pointer, options) {
		var bkg = pointer.bkg;
	...
	self.create = function () {
		var group = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
...
var Phaser = __webpack_require__(0);
var _ = __webpack_require__(1);
var versionData = __webpack_require__(7);
...
module.exports = function (game) {
	...
	var dragPointManager = __webpack_require__(2)(game);
	...
	lulu.newFolder = function (name, options) {
	...
	lulu.ajustSprite = __webpack_require__(8)(lulu, game);

	lulu.ajust = __webpack_require__(9)(lulu, game);

	lulu.square = __webpack_require__(10)(lulu, game);

	lulu.circle = __webpack_require__(11)(lulu, game);
...
module.exports = { "version": "0.0.0", "hash": "e579bf8" };
...
module.exports = function (lulu, game) {
	...
	var setDrag = function setDrag(sprite, options, folder) {
	...
	var setPivoter = function setPivoter(sprite, options, folder) {
	...
	var setScale = function setScale(sprite, options, folder) {
	...
	var setBasics = function setBasics(sprite, options, folder) {
...
module.exports = function (lulu, game) {
	...
	var setBody = function setBody(square, folder, options) {
		...
		var updateRect = function updateRect() {
			...
			body.beginFill('0xFF0000', 0.1).lineStyle(1, '0xFF0000', 0.5);
	...
	var setDrag = function setDrag(square, options, folder) {
		...
		midPoint.onPress.add(function () {
			return square.onDragStart.dispatch();
		});
		midPoint.onRelease.add(function () {
			return square.onDragStop.dispatch();
		});
	};

	var setPoints = function setPoints(square, folder, options) {
		var data = square.data;
	...
	var setData = function setData(square, folder, options) {
		var data = square.data;
		var points = square.points;
	...
	var setMethods = function setMethods(square, folder, options) {
		var data = square.data;
		var points = square.points;
...
module.exports = function (lulu, game) {
	...
	var setBody = function setBody(circle, folder, options) {
	...
	var setDrag = function setDrag(circle, options, folder) {
		...
		midPoint.onPress.add(function () {
			return circle.onDragStart.dispatch();
		});
		midPoint.onRelease.add(function () {
			return circle.onDragStop.dispatch();
		});
	};

	var setPoints = function setPoints(circle, folder, options) {
		var data = circle.data;
	...
	var setData = function setData(circle, folder, options) {
		var data = circle.data;
		var points = circle.points;
	...
	var setMethods = function setMethods(circle, folder, options) {
		var data = circle.data;
		var points = circle.points;
